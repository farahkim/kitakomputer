...
include "../../koneksi.php";
$id =  $_GET['kode'];
$query_mysql = mysqli_query($mysqli,"SELECT * FROM hp WHERE kode='$id'")or die(mysqli_error($mysqli));

while($data = mysqli_fetch_array($query_mysql)){
  ?>
  
  
  <h2>&emsp;&emsp;INPUT DATA HP</h2>
  <ol>	
    <p>Halaman ini berisi untuk update stock hp pada Toko Kita Komputer. Silahkan inputkan data hp dibawah ini :<p>
    </ol>
    <ol>
      
      <form enctype="multipart/form-data" action="proses_edit_hp.php" method="POST">
        <!-- kode -->
          ...
          <div class="col-auto my-1">
            <select class="custom-select mr-sm-2" type="text" id="inlineFormCustomSelect" name="merk" value="<?php echo $data['merk'] ?>">
             <option selected>Pilih...</option>
              ...
              <option value="Huawei">Vivo</option>
            </select>
          </div>
        </div>
...
<br><br><br><br><br>
<h2 style="font-size:15px" ><center>&emsp;*Halaman admin kita komputer cilacap .</center></h2>
<br><br>
</div>
