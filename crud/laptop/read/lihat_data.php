...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link disabled" href="#" style="color:black" >Data Laptop</a>
      </li>
    </ul>
  </div>
  </nav>
  	...
  	<h2>&emsp;&emsp;Lihat Data Laptop</h2>
		 <ol>	
	 <p>Halaman ini untuk melihat data laptop.<p>
  	 </ol>
	 <ol>
	 <?php
include "../../koneksi.php";
$panggil="SELECT * FROM laptop";
...
<td valign='top'><a href='../lihat_detail_laptop.php?kode=$kode' style='color:blue'>&emsp;&emsp;&emsp;Lihat</a></td>
<td valign='top'><a href='../update/edit_laptop.php?kode=$kode' style='color:green'>Edit</a></td>
<td valign='top'><a href='../delete/hapus_laptop.php?kode=$kode' style='color:red'>Hapus</a></td>
</tr>
