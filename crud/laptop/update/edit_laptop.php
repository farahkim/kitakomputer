...
<html lang="en">
   	...
   	<nav id="sidebar">
   		...
   		<ul class="list-unstyled components">
			...
			<li>
   			...
   			<li>
   				<a href="../../../main/tentang.php">Kritik Saran</a>
   			</li>
   			<li>
  ...
  include "../../koneksi.php";
  $id =  $_GET['kode'];
  $query_mysql = mysqli_query($mysqli,"SELECT * FROM laptop WHERE kode='$id'")or die(mysqli_error($mysqli));
  
  while($data = mysqli_fetch_array($query_mysql)){
  ?>
  	
  	
  	<h2>&emsp;&emsp;INPUT DATA LAPTOP</h2>
		 <ol>	
	 <p>Halaman ini berisi untuk update stock laptop pada Toko Kita Komputer. Silahkan inputkan data laptop sesuai kebutuhan anda dibawah ini :<p>
  	 </ol>
	 <ol>
	 
	 <form enctype="multipart/form-data" action="proses_edit_laptop.php" method="POST">
		<!-- kode -->
  ...
  <div class="form-group row">
    ...
    <div class="col-auto my-1">
      <select class="custom-select mr-sm-2" type="text" id="inlineFormCustomSelect" name="merk" value="<?php echo $data['merk'] ?>">
		...
		<option value="Lenovoo">Lenovo</option>
