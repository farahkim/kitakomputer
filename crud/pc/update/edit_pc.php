...
include "../../koneksi.php";
$id =  $_GET['kode'];
$query_mysql = mysqli_query($mysqli,"SELECT * FROM pc WHERE kode='$id'")or die(mysqli_error($mysqli));
...
while($data = mysqli_fetch_array($query_mysql)){
  ...
  <ol>	
    ...
    <ol>
      ...
      <form enctype="multipart/form-data" action="proses_edit_pc.php" method="POST">
        <!-- kode -->
