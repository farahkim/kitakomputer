...
<body>
 ...
 <div class="content">
   <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link disabled" href="#" style="color:black" >Data PC</a>
        </li>
      </ul>
    </div>
  </nav>
  ...
  <h2>&emsp;&emsp;Lihat Data PC</h2>
  <ol>	
    <p>Halaman ini untuk melihat data PC.<p>
    </ol>
    <ol>
      <?php
      include "../../koneksi.php";
      $panggil="SELECT * FROM pc";
      ...
      while($tampil=$hasil->fetch_array()){
       ...
       <td valign='top'><a href='../lihat_detail_pc.php?kode=$kode' style='color:blue'>&emsp;&emsp;&emsp;Lihat</a></td>
       <td valign='top'><a href='../update/edit_pc.php?kode=$kode' style='color:green'>Edit</a></td>
       <td valign='top'><a href='../delete/hapus_pc.php?kode=$kode' style='color:red'>Hapus</a></td>
       </tr>
