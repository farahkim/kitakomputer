...
<table   cellpadding="16">
  <tr>
    <td> 
     ...
     $kode=$_GET['kode'];
     $panggil="SELECT * FROM acc WHERE kode='$kode'";
     ...
     echo "<h3><center>DETAIL ACC KODE&nbsp$kode</center></h3>
     <hr>";
     ...
     <div class="card" style="width: 78rem; height: 75rem;">
      ...
      <div class="card-body">
       ...
       <br><br>
       <a href="#" class="btn btn-primary">Kondisi&nbsp<?php echo"$kondisi"?>&nbspdengan harga<?php echo"&nbsp$harga"?></a>
       <br><br>
